      ...
      <div className="w-full max-w-[420px] animate-in fade-in zoom-in-95 duration-700">
        ...
        <div className="glass-effect p-10 rounded-[32px] border border-border-light shadow-2xl relative">
          <div className="mb-10 text-left">
            <h3 className="text-2xl font-bold text-text-primary tracking-tight mb-1.5">Local Admin Login</h3>
            <p className="text-text-secondary text-xs font-medium opacity-80">Access your local deployment dashboard.</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-7">
            <div className="space-y-2.5">
              <label className="block text-[10px] font-bold text-text-muted uppercase tracking-[0.1em] ml-1">Username or Email</label>
              <div className="relative group">
                ...
                <input
                  ...
                  className="w-full bg-bg-primary/50 border border-border-light focus:border-blue-500/50 rounded-2xl px-12 py-3.5 text-text-primary text-xs font-bold outline-none transition-all focus:ring-8 focus:ring-blue-500/[0.04]"
          ...
          <div className="mt-10 pt-8 border-t border-border-light text-center space-y-4">
            ...
            <p className="text-[9px] font-medium text-text-muted/60 max-w-[85%] mx-auto leading-relaxed">
              Forgot your password? As this is a local-only app, you must delete your SQLite database (<code className="bg-bg-primary px-1 py-0.5 rounded text-amber-500/80">backend/prisma/dev.db</code>) and restart to create a new admin account. This will wipe your configurations.
            </p>
          </div>
        </div>
      </div>
